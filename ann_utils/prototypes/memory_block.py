...
class MemoryBlock(object):
    ...
    def __init__( self,
        ...
        self.blockx = SOMLayer( "{}_block_x".format( name ), int( m / 2 ), int( n / 2 ), epoch, lr, nr, gstd, act )
        self.blockh = SOMLayer( "{}_block_h".format( name ), int( m / 2 ), int( n / 2 ), epoch, lr, nr, gstd, act )
